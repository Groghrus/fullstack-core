...
- **Additive change (расширяющее изменение)** — добавление поля/метода при сохранении совместимости. По принципу «постепенной совместимости» (Vice versa: Practioner) новые поля — usually safe, если клиенты не требуют их.
