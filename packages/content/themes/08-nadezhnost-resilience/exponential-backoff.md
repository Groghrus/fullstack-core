...
- **Jitter (разброс)** — случайное смещение паузы, обяз-ательное для тысяч клиентов: без него все попадают в «стандартные» окна. Виды: *full jitter* (случайное 0…delay), *equal jitter* (delаy ± половина), *decorrelated* (между половиной и 3/2 базовой).
